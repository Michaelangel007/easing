 ...
 * [Cleanup - In Cubic](#cleanup---in-cubic)
 * [Cleanup - In Elastic](#cleanup---in-elastic)
 * [Cleanup - In Exponent 2](#cleanup---in-exponent-2)
 * [Cleanup - In Exponent e](#cleanup---in-exponent-e)
 * [Cleanup - In Log10](#cleanup---in-log10)
 * [Cleanup - In Octic](#cleanup---in-octic)
 * [Cleanup - In Quadratic](#cleanup---in-quadratic)
 * [Cleanup - In Quartic](#cleanup---in-quartic)
 * [Cleanup - In Quintic](#cleanup---in-quintic)
 * [Cleanup - In Septic](#cleanup---in-sextic)
 * [Cleanup - In Sextic](#cleanup---in-septic)
 * [Cleanup - In Sine](#cleanup---in-sine)
* [Cleanup Out](#cleanup---out)
 * [Cleanup - Out Back](#cleanup---out-back)
 * [Cleanup - Out Bounce](#cleanup---out-bounce)
 * [Cleanup - Out Circle](#cleanup---out-circle)
 * [Cleanup - Out Cubic](#cleanup---out-cubic)
 * [Cleanup - Out Elastic](#cleanup---out-elastic)
 * [Cleanup - Out Exponent 2](#cleanup---out-exponent-2)
 * [Cleanup - Out Exponent e](#cleanup---out-exponent-e)
 * [Cleanup - Out Log10](#cleanup---out-log10)
 * [Cleanup - Out Octic](#cleanup---out-octic)
 * [Cleanup - Out Quadratic](#cleanup---out-quadratic)
 * [Cleanup - Out Quartic](#cleanup---out-quartic)
 * [Cleanup - Out Quintic](#cleanup---out-quintic)
 * [Cleanup - Out Septic](#cleanup---out-sextic)
 * [Cleanup - Out Sextic](#cleanup---out-septic)
 * [Cleanup - Out Sine](#cleanup---out-sine)
* [Cleanup In Out](#cleanup-in-out)
 * [Cleanup - In Out Back](#cleanup---in-out-back)
 * [Cleanup - In Out Bounce](#cleanup---in-out-bounce)
 * [Cleanup - In Out Circle](#cleanup---in-out-circle)
 * [Cleanup - In Out Cubic](#cleanup---in-out-cubic)
 * [Cleanup - In Out Elastic](#cleanup---in-out-elastic)
 * [Cleanup - In Out Exponent 2](#cleanup---in-out-exponent-2)
 * [Cleanup - In Out Exponent e](#cleanup---in-out-exponent-e)
 * [Cleanup - In Out Log10](#cleanup---in-out-log10)
 * [Cleanup - In Out Octic](#cleanup---in-out-octic)
 * [Cleanup - In Out Quadratic](#cleanup---in-out-quadratic)
 * [Cleanup - In Out Quartic](#cleanup---in-out-quartic)
 * [Cleanup - In Out Quintic](#cleanup---in-out-quintic)
 * [Cleanup - In Out Septic](#cleanup---in-out-sextic)
 * [Cleanup - In Out Sextic](#cleanup---in-out-septic)
 * [Cleanup - In Out Sine](#cleanup---in-out-sine)
